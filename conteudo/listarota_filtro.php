<?php
  ...
  $sql_code = "SELECT r.rot_id, r.rot_nome, r.rot_preco, v.vei_nome, m.mot_nome, u.uni_nome, r.rot_turno FROM Rota r, Veiculo v, Motorista m, Universidade u WHERE (r.vei_id = v.vei_id AND r.mot_id = m.mot_id AND r.uni_id = u.uni_id) 
  AND (rot_nome LIKE '%$rota%' OR vei_nome LIKE '%$rota%' OR mot_nome LIKE '%$rota%' OR uni_nome LIKE '%$rota%' OR rot_turno LIKE '%$rota%' OR rot_preco LIKE '%$rota%') AND r.emp_id = $emp_id order by r.rot_nome";
              ...
              <div class="box-body">
                <table id="example" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <a href="javascript: if(confirm('Tem certeza que deseja deletar essa Rota ?'))
                  location.href='deletaritinerario.php?rot_id=<?php echo $linha['rot_id']; ?>';">Deletar &emsp;</a>
                  </td>
                  </tr>
                  </tbody>
