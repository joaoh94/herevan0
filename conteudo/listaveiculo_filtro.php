<?php
  ...
  $sql_code = "SELECT * FROM Veiculo WHERE (vei_nome LIKE '%$veiculo%' OR vei_marca LIKE '%$veiculo%' OR vei_ano_modelo LIKE '%$veiculo%' OR vei_placa LIKE '%$veiculo%') AND emp_id = $emp_id";
